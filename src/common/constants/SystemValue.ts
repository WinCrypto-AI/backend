...
export const SystemValue = {
  ...
  LIST_GROUP: [
    {
      code: GROUP_CODES.group_free,
      name: 'GROUP FREE GLOBAL',
      type: NSChatGroup.EType.GLOBAL,
      mode: NSChatGroup.EMode.GROUP,
    },
    {
      code: GROUP_CODES.group_200u,
      name: 'GROUP 200U GLOBAL',
      type: NSChatGroup.EType.GLOBAL,
      mode: NSChatGroup.EMode.GROUP,
    },
    {
    ...
    {
      code: GROUP_CODES.group_free_vn,
      name: 'GROUP FREE VN',
      type: NSChatGroup.EType.VN,
      mode: NSChatGroup.EMode.GROUP,
    },
    {
      code: GROUP_CODES.group_200u_vn,
      name: 'GROUP 200U VN',
      type: NSChatGroup.EType.VN,
      mode: NSChatGroup.EMode.GROUP,
    },
    ...
    {
      code: GROUP_CODES.channel_broker_vn,
      name: 'CHANNEL BROKER VN',
      type: NSChatGroup.EType.VN,
      mode: NSChatGroup.EMode.CHANNEL,
    },
  ],
